    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 overflow-hidden" data-section="0">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-indigo-500/20 to-purple-600/20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-pink-500/20 to-rose-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className={`text-center max-w-6xl mx-auto transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 bg-clip-text text-transparent mb-6 tracking-tight">
            Eat Sip Repeat
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-10 py-6 text-lg font-semibold transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-2xl rounded-2xl group"
            >
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-slate-300 text-slate-700 hover:bg-slate-50 px-10 py-6 text-lg font-semibold transition-all duration-300 hover:scale-105 rounded-2xl group backdrop-blur-sm"
            >
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {tools.map((tool) => (
              <Badge 
                key={tool.name} 
                variant="secondary" 
                className="bg-white/60 backdrop-blur-sm text-slate-700 hover:bg-white/80 transition-all duration-300 hover:scale-105 px-4 py-2 text-sm font-medium border border-slate-200/50 shadow-sm"
              >
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-slate-400 rounded-full p-1">
            <div className="w-1 h-3 bg-slate-400 rounded-full mx-auto animate-pulse"></div>
          </div>
        </div>
      </section>

      {/* Problem Statement - Modern Card Layout */}
      ...
      {/* Solution Approach - Modern Timeline */}
      <section className="py-24 px-6 bg-gradient-to-br from-slate-50 to-white" data-section="2">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
          ...
          <div className="space-y-8">
            {timelineSteps.map((step, index) => (
              <Card 
                key={step.phase}
                className="group relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white/80 backdrop-blur-sm rounded-3xl"
              >
                <div className="relative p-10">
                  <div className="grid lg:grid-cols-3 gap-10 items-center">
                    <div className="flex items-center space-x-6">
                      ...
                      <div>
                        <Badge className="bg-slate-100 text-slate-700 mb-3 px-3 py-1 font-medium">{step.phase}</Badge>
                    ...
                    <div className="text-center lg:text-right">
                      <div className="bg-gradient-to-r from-slate-100 to-slate-200 p-6 rounded-2xl">
      ...
      {/* What's Next - Modern Dark Section */}
      <section className="py-24 px-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden" data-section="4">
        {/* Background Elements */}
        <div className="absolute inset-0 -z-10">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-indigo-500/20 to-purple-600/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-pink-500/20 to-rose-600/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center mb-20">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-indigo-500 to-purple-600 mx-auto mb-8 rounded-full"></div>
          </div>
            ...
            <Card className="relative overflow-hidden bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl">
              ...
              <div className="relative p-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white group rounded-2xl px-8 py-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
            <div className="flex items-center space-x-8">
              ...
              <div className="flex space-x-8 text-sm font-medium">
                ...
                <span className="text-slate-500">·</span>
                <a href="mailto:polina@example.com" className="hover:text-indigo-400 transition-colors">Contact</a>
              </div>
            </div>
